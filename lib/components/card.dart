...
class Card extends PositionComponent {
  ...
  static final Sprite flameSprite = KlondikeUtil.klondikeSprite(1367, 6, 357, 501);
  ...
  static final Sprite redJack = KlondikeUtil.klondikeSprite(81, 565, 562, 488);
  static final Sprite redQueen = KlondikeUtil.klondikeSprite(717, 541, 486, 515);
  static final Sprite redKing = KlondikeUtil.klondikeSprite(1305, 532, 407, 549);
  static final Sprite blackJack = KlondikeUtil.klondikeSprite(81, 565, 562, 488)
    ..paint = blueFilter;
  static final Sprite blackQueen = KlondikeUtil.klondikeSprite(717, 541, 486, 515)
    ..paint = blueFilter;
  static final Sprite blackKing = KlondikeUtil.klondikeSprite(1305, 532, 407, 549)
    ..paint = blueFilter;
